...
- **💡 Example Queries**:
  - *"What was our sales revenue in the year 2022?"*
  - *"Total profit in January 2025?"*
  - *"Show me transaction volume for 2026"*
...
- **💡 Example Queries**:
  - *"What's the weather today in New Delhi?"*
  - *"What is a good recipe for baking chocolate chip cookies?"*
...
- **💡 Example Queries**:
  - *"Which customer segments should we target for retention?"*
  - *"Which products are at risk of running out of stock?"*
  - *"What is the ROI of our marketing campaigns?"*
  - *"What is the performance of customer support?"*
  - *"Summarize common customer support ticket issues"*
