...
def train_model():
    ...
    customers_path = os.path.join(base_dir, 'Data', 'Raw', 'customers.csv.xlsx')
    transactions_path = os.path.join(base_dir, 'Data', 'Raw', 'transactions.csv.xlsx')
    ...
    save_dir = os.path.join(base_dir, 'chatbot')
    os.makedirs(save_dir, exist_ok=True)
    joblib.dump(model_data, os.path.join(save_dir, 'churn_model.joblib'))
    print(f"Saved model artifacts to {os.path.join(save_dir, 'churn_model.joblib')}")
