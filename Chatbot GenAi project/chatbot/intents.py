...
from chatbot.data_loader import get_dataset, get_churn_model
    ...
    if model_data is not None:
        try:
            ...
            features = pd.DataFrame(
                [[cust_age, gender_encoded, region_encoded, cust_orders, cust_ltv, recency]],
                columns=['age', 'gender_encoded', 'region_encoded', 'total_orders', 'lifetime_value', 'recency']
            )
